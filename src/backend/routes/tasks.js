...
const { pageTasks } = require('./tasks-pagination');

// All routes below require authentication
router.use(authMiddleware);

// GET /api/tasks - Paginated task list for logged-in user
router.get('/', (req, res) => {
  return pageTasks({ db, userId: req.user.id, query: req.query, res });
});
